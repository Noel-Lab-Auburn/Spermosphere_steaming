...
# Mean separation
lsmeans <- emmeans(RichStat.B, ~Trt|Type.revised*Time) # effect of treatment within combinations of type and time.

Results_lsmeansEC <- multcomp::cld(lsmeans, alpha = 0.05, reversed = TRUE, details = TRUE, Letters = letters) # contrast with Tukey adjustment
...
##Faiths PhlyoGenetic Diversity Statistics
...
# Mean separation
lsmeans <- emmeans(RichStat.C, ~Trt|Type.revised*Time) # effect of treatment within combinations of type and time.
